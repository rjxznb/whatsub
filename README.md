...
最新客户端由 `download.eversay.cc` 多吉云 CDN 提供国内下载，GitHub Releases 作为备用源：[GitHub Releases](https://github.com/rjxznb/whatsub-releases/releases/latest)。Windows 使用 NSIS `*-setup.exe`，macOS Apple Silicon 使用 `.dmg`。
