...
export function Corpus() {
  ...
  // 按视频来源: the selected source GROUP KEY (yt:<id> | url:<host> | manual) for
  // the source-detail panel + a mirror of the browse layout (reported up by
